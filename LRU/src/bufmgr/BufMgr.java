...
//-------------------------------------------------------------
    ...
    */
    // Init BHR variables
    protected int totPageHits = 0;
    protected int totPageRequests = 0;
    protected int pageLoadHits = 0;
    protected int pageLoadRequests = 0;
...
//-------------------------------------------------------------
  ...
  {   
      ...
      replacer = new Lru(this);   // change Policy to replacement class name
  }
